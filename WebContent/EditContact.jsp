...
<form action="searchContacts.do">
Enter Contact Name to edit:<input type="text" name="search"><br>
...
for(ContactBean rb:list){
	out.print("<tr><td>"+rb.getName()+"</td><td>"+rb.getEmail()+"</td><td>"+rb.getPhone()+"</td><td>"+rb.getDob()+"</td><td>"+rb.getTags()+"</td><td><a href='openUpdateContact.do?email="+rb.getEmail()+"'>Edit</a></td><td><a href='deleteContact.do?email="+rb.getEmail()+"'>Delete</a></td></tr>"); 
}
out.print("</table>"); 
